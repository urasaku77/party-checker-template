...
export function Input(props:Props) {
  ...
  return (
    <Autocomplete
      ...
      renderInput={(params) => <TextField {...params} label={props.num.toString()+data.label} error={errorMessage[0].includes("禁止")} className={errorMessage[0].includes("制限") ? classes.warningStyles : undefined}
